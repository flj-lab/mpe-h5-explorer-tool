...
# met.check_h5_file(high_freq_cycles_path, output_file="high_freq_h5_check.txt")
...
# met.combine_and_sort_h5_files([low_freq_cycles_path, high_freq_cycles_path], output_file_path)
...
x_data, y_data, x_label, y_label, title_str, x_unit, y_unit = met.get_h5_plot_stuff(output_file_path, x_signal_name=b"Running Time", y_signal_name=b"Axial Force")
